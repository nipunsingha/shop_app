                              ...
                              <div class="row " style="margin-bottom: 25px;">
                                ...
                                <div class="col-md-4 cartst">
                                    <div class="form-group">
                                       ...
                                       <select id="pay_st" class="form-control cartst" name="status" style="width: 100%">
                                ...
                                <div class="col-md-4 cartst">
                                  <div class="form-group ">
                                    <label>Note</label><br>
                                    <textarea class="form-control cartst" id="cart_comment" name="cart_comment" rows="2" placeholder="Note"></textarea>           
                                  </div> 
                                </div>
                              </div>
